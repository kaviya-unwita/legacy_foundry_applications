...
export default function SSAApp({ onSwitch }) {
    ...
    <div className={`app ${collapsed ? 'nav-collapsed' : ''}`}>
      ...
      <section className="workspace">
        <header className="topbar">
          ...
          <div className="top-actions"><div className="application-context"><span>APPLICATION</span><select className="app-switcher" value="ssa" onChange={(event) => onSwitch(event.target.value)}><option value="ssa">SSA Foundry</option><option value="veeyes">Veeyes ERP</option></select></div><div className="plant"><span></span><div><strong>Company / unit not set</strong><small>Legacy scopes data by COMPCODE / UNITCODE</small></div></div></div>
        </header>
