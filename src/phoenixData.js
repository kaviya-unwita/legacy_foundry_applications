...
const MASTER_LEGACY_EVIDENCE = {
  ...
  materials: { sun: 'ALLOYMAST / Grade alloy references', yes: 'Alloy Type / casting-type references', level: 'related' },
  grades: { sun: 'GRADE', yes: 'Grade Master', level: 'confirmed' },
  'item-categories': { sun: 'GROUP MASTER / ITEM MASTER', yes: 'Grade Group / Scrap Group / Customer Group references', level: 'related' },
  'uom-conversions': {},
...
const VERIFIED_FIELD_ALIASES = {
  ...
  'business-partners': {
    ...
    roles: [null, null], category: [null, null], taxId: ['CUSTOMER.GSTNO / supplier tax fields', 'GST No — Customer Master'],
    currency: ['CUSTOMER.CURRENCY', 'Currency — Customer Master'], paymentTerms: ['CUSTOMER.PAYMENT / MASSUPPLIER.PAYMENT', 'Payment Terms — Customer Master'],
    approvedSupplier: ['MASSUPPLIER approval fields', null], creditDays: ['CUSTOMER.CREDITDAYS / MASSUPPLIER.CREDITDAYS', 'Credit Days — Customer Master'], status: [null, 'Active / Inactive — Customer Master'],
  },
  'partner-sites': {
    code: [null, null], partner: [null, null], siteType: [null, null],
    address: ['Customer/Supplier address fields', 'Billing, delivery and shipment addresses — Customer Master'],
    country: [null, 'Billing / Delivery Country — Customer Master'], state: ['MASSUPPLIER.STATE', 'State — End/Delivery Customer Master'],
    contactPerson: ['Contact Person — Supplier Master', 'Contact Person — Customer Master'], email: ['E-mail — Supplier Master', 'Contact Email — Customer Master'],
    phone: ['Phone — Supplier Master', 'Contact Phone — Customer Master'], isDefault: [null, null], status: [null, null],
  },
  items: {
    code: ['ITEMMAST.ITEMCODE — Item Master', 'Product Code / Product — Product Master'],
    name: ['ITEMMAST.NAME — Item Master', 'Name / Description — Product Master'], type: ['ITEMMAST.MATL_TYPE — Item Master', null],
    baseUom: ['ITEMMAST.UNIT — Item Master', 'Unit — Product Master'], material: [null, null], grade: ['ITEMMAST.GRADE — Item Master', 'Grade — Product Master'],
    description: [null, 'Description — Product Master List'], traceability: [null, 'Furnace Track — Product Master'], status: [null, 'Status / In Active — Product Master'],
  },
  grades: {
    code: ['GRADMAST.GRADE / Grade — Grade Master', 'Grade — Grade Master'], name: ['Standard — Grade Master', 'Standard — Grade Master'],
    material: ['Alloy / Casting Type — Grade Master', 'Alloy Type — Grade Master'], standard: [null, null], description: ['Remarks — Grade Master', 'Remarks — Grade Master'], status: [null, 'Active — Grade Master'],
  },
  'assets-equipment': {
    code: ['Code — Machine/Equipment/Furnace Master', 'Code — Crucible / Heat Treatment Furnace'], name: ['Name — Machine/Equipment Master', 'Name — Crucible / Heat Treatment Furnace'],
    equipmentType: [null, 'Type — Crucible / Heat Treatment Furnace'], category: [null, null], plant: [null, null], workCentre: ['Location — Machine Master', null],
    manufacturer: ['Make — Machine Master', null], model: ['Model / Year of Purchase — Machine Master', null], serialNo: [null, null], commissionedOn: ['Date of Installation — Machine Master', 'Date — Crucible / Heat Treatment Furnace'],
    criticality: [null, null], maintenanceRequired: [null, null], calibrationRequired: [null, null], ratedCapacity: ['Capacity — Machine Master', 'Capacity — Crucible / Heat Treatment Furnace'],
    capacityUom: [null, null], measurementRange: ['Range — Equipment Master', null], energySource: [null, null], calibrationFrequencyDays: ['Frequency — Equipment Master', null], status: [null, null],
  },
  processes: {
    code: ['Process Code / Code — Casting Process Master', 'Code — Casting Process Entry'], name: ['Name — Casting Process Master', 'Name — Casting Process Entry'],
    sequence: ['Order — Casting Process Master', null], department: [null, null], description: [null, null], status: [null, null],
  },
  defects: {
    code: ['Code — REJECTION master', 'Code — Rejection Reasons'], name: ['Name — REJECTION master', 'Short / description — Rejection Reasons'],
    category: [null, null], detectedAt: [null, null], severity: [null, null], description: [null, null], status: [null, null],
  },
  currencies: {
    code: ['Ccode — Currency master', 'Code — Currency Master'], name: ['Currency Name — Currency master', 'Currency Name — Currency Master'],
    symbol: ['Symbol — Currency master', 'Symbol — Currency Master'], decimalPlaces: [null, null], status: [null, null],
  },
  'tax-codes': {
    code: [null, 'Tax Code — Tax Master'], name: [null, 'Tax Description — Tax Master'], taxType: [null, 'Tax type — Tax Master'],
    rate: [null, 'IGST / SGST / CGST / Tax — Tax Master'], hsnSac: [null, null], effectiveFrom: [null, null], status: [null, null],
  },
}
